...
<meta name="viewport"
	content="width=150, initial-scale=1, maximum-scale=15, user-scalable=1" />
...
?>
	...
	<div id="nav">
		<a href="#" onclick="changeSection(1)">PINs</a> <a href="#"
			onclick="changeSection(2)">Log</a> <a href="#"
			onclick="changeSection(3)">Config</a>
		...
		<div class="login_form">
			...
			<form method="POST">
				<label>Username</label> <input type="text" name="username"
					id="username" placeholder="your username" /><br /> <label>Password</label>
				<input type="password" name="pasword" id="password"
					placeholder="your password" /><br /> <input type="submit"
					id="submit_login" name="submit" class="inputbutton grey"
					value="Login" /> <span class="login_loading"></span> <span
					class="errormess"></span>
			</form>
		</div>
	</div>
</body>
